...
echo ""
echo "  Optional — server mint API (/api/faucet) on Vercel:"
echo "  DEPLOYER_SECRET_KEY=<same identity secret as stellar keys $IDENTITY>"
echo ""
echo "  Testnet UI can also mint without server secrets via claim_testnet_drip (user signs in Freighter)."
echo ""
